...
import com.example.data.TeamRepositoryImpl;
...
public class TeamsResourceDocumentation {
    ...
    public static final ResourceTestRule resource = ResourceTestRule.builder()
            ...
            .addResource(new TeamsResource(new TeamRepositoryImpl()))
            .build();
    ...
    public void deleteTeam() {
        ...
        response = client.target("http://localhost:9998/teams/5").request().get();
