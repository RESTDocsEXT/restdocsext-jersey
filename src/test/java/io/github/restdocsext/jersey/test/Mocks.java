...
/**
 * Utility class to create mocks Jersey components. The methods return builders from which the user
 * can build mock expectations for the mock objects. An example of creating a {@code ClientRequest}
 * mock would be something like
 *
 * <pre>
 ...
 * {@code MessageBodyWorkers} that will perform and actual read or write of the Java entity type to
 * the stream. In most cases you will just pass a {@code ByteArrayOutput(Input)Stream)} to get the
 * entity in bytes.
 *
...
public final class Mocks {
	...
	/**
	 * Create a client request mock builder. Calls to the builder methods will build expectations on
	 * the mock object.
	 *
	...
	/**
	 * Create a client response mock builder. Calls to the builder method will build expectation on
	 * the mock object.
	 *
